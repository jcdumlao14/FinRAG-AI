...
if result is not None:
    ...
    download_text = (
        "FinRAG AI - Financial Research Assistant\n"
        + "=" * 60
        + "\n\n"
        + "QUESTION\n"
        + "-" * 60
    ...
    if sources:
        ...
        for i, source in enumerate(
            ...
            download_text += (
                ...
                f"Fiscal Year: {source.get('year', 'Unknown')}\n"
                f"Document: {source.get('filename', 'Unknown')}\n"
    ...
    download_text += (
        ...
        + "=" * 60
        + "\n"
        + "Generated by FinRAG AI\n"
    )

    st.download_button(
        label="📥 Download Answer",
        data=download_text,
        file_name="finrag_answer.txt",
        mime="text/plain",
        use_container_width=True,
    )
